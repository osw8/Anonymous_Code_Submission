...
echo BUDGET_UNIT=detection_seizure_event_bundle_prediction_seizure_event
...
echo DETECTION_TARGET_BUDGET_SAMPLING=complete_event_all_ictal_dynamic_hard_far_one_to_two
echo PREDICTION_TRAIN_SAMPLING=dataset_aware_epoch_dynamic_preictal_anchored_one_to_one
echo PREDICTION_TARGET_BUDGET_SAMPLING=complete_event_all_preictal_dynamic_patient_balanced_interictal_one_to_one
