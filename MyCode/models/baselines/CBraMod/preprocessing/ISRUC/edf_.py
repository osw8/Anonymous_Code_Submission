...
def _read_edf_header(fname, exclude, infer_types, include=None):
    ...
    with open(fname, "rb") as fid:
        ...
        record_length = np.array([record_length, 1.0])  
        ...
        if subtype == "bdf":
            edf_info["dtype_byte"] = 3  
            edf_info["dtype_np"] = UINT8
        else:
            edf_info["dtype_byte"] = 2  
    ...
    with open(fname, "rb") as fid:
        ...
        if edf_info["number"] < 1.9:
            ...
            if etmode in (1, 3):
                ...
                pos = np.fromfile(fid, UINT32, n_events) - 1  
