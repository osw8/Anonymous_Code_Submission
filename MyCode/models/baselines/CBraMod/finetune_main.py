...
def main():
    ...
    parser.add_argument('--model_dir', type=str, default='data/models_weights/Big/BigFaced', help='model_dir')
    ...
    parser.add_argument('--foundation_dir', type=str,
                        default='./models/baselines/CBraMod/pretrained_weights/pretrained_weights.pth',
                        help='foundation_dir')
