...
class BIOTClassifier(nn.Module):
    def __init__(self, input_eeg_channel=64, emb_size=256, heads=8, depth=4, n_classes=6, **kwargs):
        super().__init__()
        self.chan_conv = torch.nn.Conv1d(input_eeg_channel, 18, kernel_size=1, bias=False) 
