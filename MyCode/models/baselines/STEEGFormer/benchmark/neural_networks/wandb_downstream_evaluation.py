...
def get_args_parser():
    ...
    parser.add_argument('--wandb_entity', default='liuyin_yang-ku-leuven', type=str,
                        help='Wandb account')
    parser.add_argument('--wandb_log_dir', default='data/benchmark_outputs/STEEGFormer/wandb', type=str,
    ...
    parser.add_argument('--vit_pretrained_model_dir', default='./models/baselines/STEEGFormer/checkpoint-300.pth', type=str,
                        help='vit pretrained model path')
    parser.add_argument('--labram_pretrained_model_dir', default='./models/baselines/LaBraM/checkpoints/labram-base.pth', type=str,
                        help='labram pretrained model path')
    parser.add_argument('--eegpt_pretrained_model_dir', default='./models/baselines/EEGPT/checkpoint/eegpt_mcae_58chs_4s_large4E.ckpt', type=str,
                        help='eegpt pretrained model path')
    parser.add_argument('--biot_pretrained_model_dir', default='./models/baselines/BIOT/pretrained-models/EEG-six-datasets-18-channels.ckpt', type=str,
                        help='biot pretrained model path')
    parser.add_argument('--bendr_pretrained_model_dir', default='checkpoints/bendr/encoder.pt', type=str,
                        help='bendr pretrained model path')
    parser.add_argument('--cbramod_pretrained_model_dir', default='./models/baselines/CBraMod/pretrained_weights/pretrained_weights.pth', type=str,
    ...
    for run_idx in range(experiment_run_split.get_number_of_runs()):
        ...
        for fold in range(args.downstream_task_fold):
            ...
            run = wandb.init(
                ...
                config={
                  **vars(args),
                  "experiment_type": args.evaluation_scheme,         
                  "stage":           "train",       
                  "fold":            fold,
                  "subject_of_interest": current_run_sub_of_interested,
                },
