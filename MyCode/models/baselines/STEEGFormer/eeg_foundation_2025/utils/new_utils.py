...
def get_dataset(args):
    if args.challenge == "challenge1":
        train_set = EEGH5Dataset("data/h5_challenge_datasets/challenge1/eeg_challenge1_dataset.h5", split="train")
        valid_set = EEGH5Dataset("data/h5_challenge_datasets/challenge1/eeg_challenge1_dataset.h5", split="valid")
        test_set = EEGH5Dataset("data/h5_challenge_datasets/challenge1/eeg_challenge1_dataset.h5", split="test")
        return train_set, valid_set, test_set
    elif args.challenge == "challenge2":
        train_set = EEGH5CropDataset("data/h5_challenge_datasets/challenge2/eeg_challenge2_dataset.h5",
                                     split="train",crop_size=200,seed=2025)
        valid_set = EEGH5CropDataset("data/h5_challenge_datasets/challenge2/eeg_challenge2_dataset.h5",
                                     split="valid",crop_size=200,seed=2025)
        test_set = EEGH5CropDataset("data/h5_challenge_datasets/challenge2/eeg_challenge2_dataset.h5",
                                    split="test",crop_size=200,seed=2025)
        return train_set, valid_set, test_set
    else:
        ch1_train = EEGH5Dataset("data/h5_challenge_datasets/challenge1/eeg_challenge1_dataset.h5", split="train")
        ch1_valid = EEGH5Dataset("data/h5_challenge_datasets/challenge1/eeg_challenge1_dataset.h5", split="valid")
        ch1_test  = EEGH5Dataset("data/h5_challenge_datasets/challenge1/eeg_challenge1_dataset.h5", split="test")

        ch2_train = EEGH5CropDataset("data/h5_challenge_datasets/challenge2/eeg_challenge2_dataset.h5",
                                     split="train",crop_size=200,seed=2025)
        ch2_valid = EEGH5CropDataset("data/h5_challenge_datasets/challenge2/eeg_challenge2_dataset.h5",
                                     split="valid",crop_size=200,seed=2025)
        ch2_test  = EEGH5CropDataset("data/h5_challenge_datasets/challenge2/eeg_challenge2_dataset.h5",
                                    split="test",crop_size=200,seed=2025)
